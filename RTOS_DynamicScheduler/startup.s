...
;******************************************************************************
		...
		IMPORT 	set_int_disable_time
		IMPORT  get_int_disable_time
...
StartCritical
		...
		;AND 	R1, R0, #0x1		; Max disable time measurement
		;CMP 	R1, #0x1			; Interupts disabled if 1 -> not record time
		;BEQ 	skip1
		;PUSH   	{R0, LR}
		;BL 		set_int_disable_time
		;POP  	{R0, LR}
